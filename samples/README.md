...
- **[midi1_serial](midi1_serial/README.rst)**: Basic MIDI serial UART transmit/receive example.
- **[midi1_clock_generator](midi1_clock_generator/src/main.c)**: Demonstrates how to generate MIDI timing clock pulses (24 PPQN) at a specific BPM.
- **[midi1_clock_measurement](midi1_clock_measurement/src/main.c)**: Shows how to measure the BPM of an incoming MIDI clock signal.
